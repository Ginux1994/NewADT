...
contains
    ...
    ! read element inf
		...
		subroutine dNdxi_radia(r, s, ndNum, nod5, coords, N, areaRadia)
			...
			dNdxi(1,1)= 0.125*sPlus
			dNdxi(1,2)=-dNdxi(1,1)
			dNdxi(1,3)=-0.125*sMinus
			dNdxi(1,4)=-dNdxi(1,3)

			dNdxi(2,1)= 0.125*rPlus
			dNdxi(2,2)= 0.125*rMinus
			dNdxi(2,3)=-dNdxi(2,2)
			dNdxi(2,4)=-dNdxi(2,1)
			Jmat = 0.0
			do i=1,2
